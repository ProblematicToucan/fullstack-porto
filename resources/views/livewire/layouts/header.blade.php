...
<nav x-data="navigationMenu"
    ...
    <div class="relative">
        <ul
            ...
            <li>
                <button @mouseover="navigationMenuOpen=true; navigationMenuReposition($el); navigationMenu='learn-more'"
                    @mouseleave="navigationMenuLeave()"
                    class="inline-flex items-center justify-center h-10 px-4 py-2 text-sm font-medium transition-colors rounded-md text-secondary-foreground hover:text-secondary-foreground/50 focus:outline-none bg-gray-50 dark:bg-gray-900 w-max">
    ...
    <div x-ref="navigationDropdown" x-show="navigationMenuOpen" x-transition:enter="transition ease-out duration-100"
        ...
        @mouseleave="navigationMenuLeave()" class="absolute top-3 duration-200 ease-out -translate-x-1/2 translate-y-11"
        x-cloak>
            ...
            <div x-show="navigationMenu == 'getting-started'"
                ...
                <div class="w-72">
                    <a href="#_" @click="navigationMenuClose()"
                        ...
                        <span class="block mb-1 font-medium text-secondary-foreground">Introduction</span>
                        <span class="block font-light leading-5 opacity-50">Re-usable elements built using Alpine JS and
                            Tailwind CSS.</span>
                    </a>
                    <a href="#_" @click="navigationMenuClose()"
                        class="block px-3.5 py-3 text-sm rounded hover:bg-secondary-foreground/10">
                        <span class="block mb-1 font-medium text-secondary-foreground">How to use</span>
                        <span class="block leading-5 opacity-50">Couldn't be easier. It is as simple as copy, paste, and
                            preview.</span>
                    </a>
                    <a href="#_" @click="navigationMenuClose()"
                        class="block px-3.5 py-3 text-sm rounded hover:bg-secondary-foreground/10">
