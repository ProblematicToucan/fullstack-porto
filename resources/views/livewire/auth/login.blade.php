<div class="flex fixed inset-0 z-[99] w-screen h-screen bg-background">
    <div class="relative top-0 bottom-0 right-0 flex-shrink-0 hidden w-1/3 overflow-hidden bg-cover lg:block">
        ...
        <img src="https://cdn.devdojo.com/images/may2023/pines-bg-1.png" alt="Login - Porto"
            ...
            <div class="relative text-center">
                ...
                <form wire:submit='authenticate' class="space-y-2">
                    ...
                    <button wire:loading.class="opacity-50" type="submit"
                        class="inline-flex items-center justify-center w-full h-10 px-4 py-2 text-sm font-medium tracking-wide text-white transition-colors duration-200 rounded-md bg-primary-600 hover:bg-primary-500 focus:ring-2 focus:ring-offset-2 focus:ring-neutral-900 focus:shadow-outline focus:outline-none">
                        Login
                    </button>
