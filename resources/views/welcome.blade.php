        ...
        <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
            <div
                ...
                <ul class="flex gap-3 text-sm leading-normal">
                    <li>
                        <x-ui.button variant="primary">Deploy now</x-ui.button>
                    </li>
                    <li>
                        <x-ui.button variant="subtle">Learn more</x-ui.button>
                    </li>
                </ul>

                {{-- Badge demo (Flux-style) --}}
                <div class="mt-8">
                    <h2 class="mb-3 text-sm font-medium text-[#1b1b18] dark:text-[#EDEDEC]">Badges</h2>
                    <div class="flex flex-wrap items-center gap-2">
                        <x-ui.badge color="lime">New</x-ui.badge>
                        <x-ui.badge size="sm">Small</x-ui.badge>
                        <x-ui.badge>Default</x-ui.badge>
                        <x-ui.badge size="lg">Large</x-ui.badge>
                        <x-ui.badge icon="heroicon-o-user-circle">Users</x-ui.badge>
                        <x-ui.badge icon="heroicon-o-document-text">Files</x-ui.badge>
                        <x-ui.badge icon-trailing="heroicon-o-video-camera">Videos</x-ui.badge>
                        <x-ui.badge rounded icon="heroicon-o-user">Pill</x-ui.badge>
                        <x-ui.badge as="button" rounded icon="heroicon-o-plus" size="lg">Amount</x-ui.badge>
                        <x-ui.badge color="lime">Admin <x-ui.badge-close /></x-ui.badge>
                    </div>
                    <p class="mt-2 text-xs text-[#706f6c] dark:text-[#A1A09A]">Soft (default) and solid variants with
                        all Flux colors available.</p>
                </div>

                {{-- Accordion demo (Flux-style) --}}
                <div class="mt-8">
                    <h2 class="mb-3 text-sm font-medium text-[#1b1b18] dark:text-[#EDEDEC]">FAQ</h2>
                    <x-ui.accordion exclusive transition>
                        <x-ui.accordion-item heading="What's your refund policy?" expanded>
                            If you are not satisfied with your purchase, we offer a 30-day money-back guarantee. Please
                            contact our support team for assistance.
                        </x-ui.accordion-item>
                        <x-ui.accordion-item heading="Do you offer any discounts for bulk purchases?">
                            Yes, we offer special discounts for bulk orders. Please reach out to our sales team with
                            your requirements.
                        </x-ui.accordion-item>
                        <x-ui.accordion-item heading="How do I track my order?">
                            Once your order is shipped, you will receive an email with a tracking number. Use this
